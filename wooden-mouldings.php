            ...
            <div class="service-details__right">
              <div class="service-details__content">
                ...
                <p class="service-details__text-1">
                  At SRB Molding (BEENU TRADERS), we specialize in manufacturing and supplying
                  high-quality wooden mouldings that add elegance, depth, and character to
                  interiors. Our wooden mouldings are crafted to enhance walls, ceilings,
                  doors, windows, furniture edges, and decorative architectural elements.
                </p>

                <p class="service-details__text-2">
                  We offer a wide range of wooden moulding profiles, finishes, and sizes
                  suitable for residential, commercial, and corporate projects. Each moulding
                  is produced using quality wood and precise finishing techniques to ensure
                  durability, consistency, and a refined appearance.
                </p>
                ...
                <p class="service-details__text-3">
                  Our wooden mouldings are designed to seamlessly integrate with furniture,
                  wall panels, ceilings, doors, and interior décor. They provide clean edges,
                  decorative detailing, and a premium finish that elevates overall interior
                  aesthetics.
                </p>

                <p class="service-details__text-4">
                  Whether for classic interiors or modern designs, SRB Molding offers wooden
                  mouldings that combine strength, style, and long-lasting performance.
                </p>
              </div>
                ...
                <ul class="list-unstyled service-details__points">
                  <li>
                    <div class="service-details__points-icon-box">
                      ...
                      <h4>Precision Wooden Profiles</h4>
                    </div>
                    <p class="service-details__points-text">
                      Accurately crafted wooden mouldings with smooth surfaces and sharp
                      detailing, ideal for walls, ceilings, furniture, frames, and decorative
                      trims.
                    </p>
                  </li>
                  ...
                  <li>
                    <div class="service-details__points-icon-box">
                      ...
                      <h4>Custom Sizes & Finishes</h4>
                    </div>
                    <p class="service-details__points-text">
                      We provide customized moulding designs, sizes, and finishes to meet
                      specific project requirements, ensuring a perfect match with interior
                      themes.
                    </p>
                  </li>
                </ul>
              ...
              <div class="service-details__benefits">
                <div class="row">
                  ...
                  <div class="col-xl-6">
                    <div class="service-details__benefits-right">
                      <h3 class="service-details__benefits-title">Why Choose Our Wooden Mouldings</h3>

                      <p class="service-betails__benefits-text-1">
                        SRB Molding (BEENU TRADERS) delivers wooden mouldings that combine
                        craftsmanship, quality materials, and competitive pricing.
                      </p>
                      ...
                      <ul class="list-unstyled service-details__benefits-points">
                        <li>
                          ...
                          <div class="text">
                            <p>Premium-quality wood material</p>
                          </div>
                        </li>
                        <li>
                          <div class="icon"><i class="icon-draw-check-mark"></i></div>
                          <div class="text">
                            <p>Strong, durable, and long-lasting</p>
                          </div>
                        </li>
                        <li>
                          <div class="icon"><i class="icon-draw-check-mark"></i></div>
                          <div class="text">
                            <p>Elegant finish for interiors and furniture</p>
                          </div>
                        </li>
                        <li>
                          <div class="icon"><i class="icon-draw-check-mark"></i></div>
                          <div class="text">
                            <p>Custom designs and profile options</p>
                          </div>
                        </li>
                        <li>
                          <div class="icon"><i class="icon-draw-check-mark"></i></div>
                          <div class="text">
                            <p>Cost-effective solutions for all projects</p>
                          </div>
                        </li>
                      </ul>
                    </div>
                ...
                <div class="service-details__benefits-bottom">
                  <h3 class="service-details__benefits-title-two">
                    Trusted Wooden Moulding Manufacturer & Supplier
                  </h3>
                  <p class="service-details__benefits-text">
                    With skilled workmanship and modern production techniques, SRB Molding
                    (BEENU TRADERS) supplies wooden mouldings that meet industry standards and
                    client expectations across India.
                  </p>
                </div>
              </div>
                ...
                <div class="accrodion-grp" data-grp-name="faq-one-accrodion">
                  ...
                  <div class="accrodion active">
                    <div class="accrodion-title">
                      <h4>Do you provide custom wooden mouldings?</h4>
                    </div>
                    <div class="accrodion-content">
                      <div class="inner">
                        <p>
                          Yes, we manufacture wooden mouldings in custom sizes, profiles, and
                          finishes based on client and project requirements.
                        </p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="accrodion">
                    <div class="accrodion-title">
                      <h4>Are your wooden mouldings suitable for commercial use?</h4>
                    </div>
                    <div class="accrodion-content">
                      <div class="inner">
                        <p>
                          Absolutely. Our mouldings are widely used in homes, offices, hotels,
                  ...
                  <div class="accrodion">
                    ...
                    <div class="accrodion-content">
                      <div class="inner">
                        <p>
                          Yes, SRB Molding (BEENU TRADERS) supplies wooden mouldings in bulk
                          quantities for dealers, interior designers, and contractors.
                        </p>
                      </div>
                    </div>
                  </div>
