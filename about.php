...
<!-- Mirrored from themazine.com/mr/woodza-html/about.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 02 Jan 2026 07:08:37 GMT -->
...
<head>
  ...
  <!-- ===== PRIMARY SEO ===== -->
  <title>About Ruby Wooden | Interior Design & Wooden Furniture Experts</title>

  <meta
    name="description"
    content="Learn about Ruby Wooden, a trusted interior design and wooden furniture company delivering custom interiors, modular kitchens, and turnkey solutions with expert craftsmanship."
  />
  <meta
    name="keywords"
    content="About Ruby Wooden, Interior Design Company, Wooden Furniture Experts, Modular Kitchen Designers, Turnkey Interior Solutions"
  />
  <meta name="author" content="Ruby Wooden" />
  <meta name="robots" content="index, follow" />

  <!-- ===== CANONICAL URL ===== -->
  <link rel="canonical" href="https://www.rubywooden.com/about" />

  <!-- ===== OPEN GRAPH (FACEBOOK / WHATSAPP) ===== -->
  <meta property="og:type" content="website" />
  <meta property="og:title" content="About Ruby Wooden | Interior Design Experts" />
  <meta
    property="og:description"
    content="Discover Ruby Wooden – experts in premium interior design, custom wooden furniture, and turnkey interior solutions."
  />
  <meta property="og:url" content="https://www.rubywooden.com/about" />
  ...
  <meta name="twitter:title" content="About Ruby Wooden | Interior Design Experts" />
  <meta
    name="twitter:description"
    content="Premium interior design and wooden furniture solutions by Ruby Wooden."
  />
  <meta name="twitter:image" content="https://www.rubywooden.com/assets/images/og-image.jpg" />

  <!-- ===== FAVICONS (UNCHANGED) ===== -->
  <link rel="apple-touch-icon" sizes="180x180" href="assets/images/favicons/apple-touch-icon1.png" />
            ...
            <div class="col-xl-6">
                <div class="problem-solved-three__left wow slideInLeft" data-wow-delay="100ms" data-wow-duration="2500ms">
                    ...
                    <div class="problem-solved-three__content">
                        <h3 class="problem-solved-three__title">5000+ Orders Fulfilled</h3>
                        <p class="problem-solved-three__text">
                            Helping framers and retailers with reliable mouldings,
                            tools, and complete framing solutions.
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="col-xl-6">
                <div class="problem-solved-three__right wow slideInRight" data-wow-delay="100ms" data-wow-duration="2500ms">
                    ...
                    <div class="problem-solved-three__call">
                        ...
                        <a href="tel : +91 98112 17586">
                            <span class="icon-phone"></span> +91 98112 17586
                        </a>
                    ...
                    <div class="about-history-three__left">
                        ...
                        <div class="about-history-three__content">
                            <h3 class="about-history-three__title">
                                Serving the framing industry with dedication and trust
                            </h3>
                            <p class="about-history-three__text">
                                Our experience, product knowledge, and commitment
                                to quality help our customers grow their business
                                with confidence.
                            </p>
                        </div>
                    </div>
            ...
            <div class="col-xl-4 col-lg-4 wow fadeInUp" data-wow-delay="300ms">
                <div class="team-one__single">
                    <div class="team-one__img">
                        ...
                        <div class="team-one__content">
                            <p class="team-one__sub-title">Sales & Operations</p>
                            <h3 class="team-one__title">
        ...
        <div class="counter-two__inner">
            ...
            <ul class="list-unstyled counter-two__list">
                ...
                <li class="wow fadeInUp" data-wow-delay="100ms">
                    ...
                    <p class="counter-two__text">Years of Industry Experience</p>
                ...
                <li class="wow fadeInUp" data-wow-delay="300ms">
                    ...
                    <p class="counter-two__text">Orders Successfully Delivered</p>
                    <div class="counter-two__icon">
                        <span class="icon-chainsaw"></span>
                    </div>
                </li>
                ...
                <li class="wow fadeInUp" data-wow-delay="400ms">
                    ...
                    <p class="counter-two__text">Retail & Wholesale Partners</p>
                    <div class="counter-two__icon">
        ...
        <div class="row">
                    ...
                    <ul class="list-unstyled contact-one__list">
                        <li>
                            ...
                            <div class="content">
                                <p>Phone Number</p>
                                <h4>
                                    <a href="tel : +91 98112 17586">+91 98112 17586</a><br>
            ...
            <div class="col-xl-6">
                <div class="contact-one__right">
                    <form action="contact-form.php" method="post" class="comment-one__form contact-form-validated" novalidate="novalidate">
                        <div class="row">
                            ...
                            <div class="col-xl-6 col-lg-6">
                                <div class="comment-form__input-box">
                                    <input type="text" placeholder="Company / Shop Name" name="company">
                                </div>
                            </div>
...
<script>(function(){function c(){var b=a.contentDocument||a.contentWindow.document;if(b){var d=b.createElement('script');d.innerHTML="window.__CF$cv$params={r:'9b786badfa021b98',t:'MTc2NzMzNzY1OC4wMDAwMDA='};var a=document.createElement('script');a.nonce='';a.src='../../cdn-cgi/challenge-platform/h/g/scripts/jsd/d39f91d70ce1/maind41d.js';document.getElementsByTagName('head')[0].appendChild(a);";b.getElementsByTagName('head')[0].appendChild(d)}}if(document.body){var a=document.createElement('iframe');a.height=1;a.width=1;a.style.position='absolute';a.style.top=0;a.style.left=0;a.style.border='none';a.style.visibility='hidden';document.body.appendChild(a);if('loading'!==document.readyState)c();else if(window.addEventListener)document.addEventListener('DOMContentLoaded',c);else{var e=document.onreadystatechange||function(){};document.onreadystatechange=function(b){e(b);'loading'!==document.readyState&&(document.onreadystatechange=e,c())}}}})();</script></body>


<!-- Mirrored from themazine.com/mr/woodza-html/about.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 02 Jan 2026 07:08:38 GMT -->
</html>