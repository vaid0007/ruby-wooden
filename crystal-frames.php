...
<body class="custom-cursor">
  ...
  <div class="page-wrapper">
    ...
    <section class="page-header">
      <div class="page-header-bg" style="background-image: url(assets/images/backgrounds/page-header-bgc.jpg)">
      </div>
      <div class="container">
  ...
  <div class="service-details__right">
    <div class="service-details__content">
      <h3 class="service-details__content-title">Crystal Frames</h3>

      <p class="service-details__text-1">
        At SRB Molding (BEENU TRADERS), we supply premium-quality crystal frames
        designed to showcase photographs, certificates, awards, and special
        memories with elegance and clarity. Our crystal frames add a modern and
        sophisticated touch to any space.
      </p>

      <p class="service-details__text-2">
        Manufactured using high-grade transparent crystal material, our frames
        offer excellent clarity, smooth edges, and long-lasting durability. They
        are available in various sizes and styles to suit both personal and
        professional display needs.
      </p>
      ...
      <p class="service-details__text-3">
        Crystal frames are ideal for table-top displays, office desks, reception
        areas, showrooms, and corporate environments. Their transparent finish
        highlights the displayed content without distraction.
      </p>

      <p class="service-details__text-4">
        SRB Molding’s crystal frames are easy to maintain, scratch-resistant, and
        designed to retain their shine and clarity over time.
      </p>
    </div>
      ...
      <ul class="list-unstyled service-details__points">
        <li>
          <div class="service-details__points-icon-box">
            ...
            <h4>High-Clarity Crystal Material</h4>
          </div>
          <p class="service-details__points-text">
            Made from premium transparent crystal material that provides excellent
            visibility and a clean, modern appearance.
          </p>
        </li>
        ...
        <li>
          <div class="service-details__points-icon-box">
            ...
            <h4>Complete Accessories Included</h4>
          </div>
          <p class="service-details__points-text">
            Supplied with all necessary accessories such as page nuts, fittings,
            and stands for easy installation and display.
          </p>
        </li>
      </ul>
    </div>
    ...
    <div class="service-details__benefits">
      <div class="row">
        ...
        <div class="col-xl-6">
          <div class="service-details__benefits-right">
            <h3 class="service-details__benefits-title">Why Choose Our Crystal Frames</h3>

            <p class="service-betails__benefits-text-1">
              SRB Molding (BEENU TRADERS) provides crystal frames that combine
              premium materials, precise finishing, and competitive pricing.
            </p>

            <ul class="list-unstyled service-details__benefits-points">
              <li>
                <div class="icon"><i class="icon-draw-check-mark"></i></div>
                <div class="text"><p>Elegant and modern appearance</p></div>
              </li>
              <li>
                <div class="icon"><i class="icon-draw-check-mark"></i></div>
                <div class="text"><p>High transparency and clarity</p></div>
              </li>
              <li>
                <div class="icon"><i class="icon-draw-check-mark"></i></div>
                <div class="text"><p>Strong and durable construction</p></div>
              </li>
              <li>
                <div class="icon"><i class="icon-draw-check-mark"></i></div>
                <div class="text"><p>Ideal for office and corporate use</p></div>
              </li>
              <li>
                <div class="icon"><i class="icon-draw-check-mark"></i></div>
                <div class="text"><p>Available with complete accessories</p></div>
              </li>
            </ul>
          </div>
        </div>
      ...
      <div class="service-details__benefits-bottom">
        <h3 class="service-details__benefits-title-two">
          Trusted Crystal Frame Supplier
        </h3>
        <p class="service-details__benefits-text">
          SRB Molding (BEENU TRADERS) supplies crystal frames to offices,
          institutions, retailers, and bulk buyers across India with assured
      ...
      <div class="accrodion-grp" data-grp-name="faq-one-accrodion">
        ...
        <div class="accrodion active">
          <div class="accrodion-title">
            <h4>Do crystal frames come with accessories?</h4>
          </div>
          <div class="accrodion-content">
            <div class="inner">
              <p>
                Yes, our crystal frames are supplied with page nuts, fittings,
                and required accessories for easy setup.
              </p>
            </div>
          </div>
        </div>
        ...
        <div class="accrodion">
          <div class="accrodion-title">
            <h4>Are crystal frames suitable for office use?</h4>
          </div>
          <div class="accrodion-content">
            <div class="inner">
              <p>
                Absolutely. Crystal frames are widely used for certificates,
                awards, and corporate displays.
              </p>
            </div>
          </div>
        </div>
        ...
        <div class="accrodion">
          <div class="accrodion-title">
            <h4>Do you supply crystal frames in bulk?</h4>
          </div>
          <div class="accrodion-content">
            <div class="inner">
              <p>
                Yes, SRB Molding (BEENU TRADERS) offers bulk supply options for
                dealers, offices, and institutional buyers.
              </p>
            </div>
          </div>
        </div>
